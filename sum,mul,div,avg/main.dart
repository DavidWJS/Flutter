...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: MyHomePage(title: 'ios Calc_Wonjung'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    setState(() {
      ...
      _output2 = calc.mul(n1, n2);
      _output3 = calc.div(n1, n2);
      _output4 = calc.avg(n1, n2);
      _nyc = _output +
          sp +
          _output2.toLowerCase() +
          sp +
          _output3.toLowerCase() +
          sp +
          _output4.toLowerCase();
    });
  }
...
class Calculate {
  ...
  String div(double num1, double num2) {
    String a;
    result = num1 / num2;
    a = result.toStringAsFixed(2);
    return 'The division is ' + a;
  }
